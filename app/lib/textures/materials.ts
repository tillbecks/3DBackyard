...
import { BRICK_SHADER, ROOF_TILE_SHADER, ROOF_FLAT_TILE_SHADER, ROOF_NORFOLK_TILE_SHADER } from './shader/shaderConfig';
...
const BRICK_MATERIAL_SANDSTONE = new THREE.MeshStandardMaterial({color: COLORS.BRICK_COLOR_RED, roughness: 0.9}); 
...
export function getHouseMaterials(): Record<string, TYPES.MaterialMix> {
   return { 
    ...
    brickMaterialSandstone: {standardMaterial: BRICK_MATERIAL_SANDSTONE, shaderMaterial: BRICK_SHADER.getShaderMaterialConfig(COLORS.BRICK_COLOR_RED)},
  };
}
